...
const routes = [
    ...
    { path: '/admin/academic-years', component: () => import('../views/AdminAcademicYears.vue'), meta: { requiresAuth: true, role: 'admin', title: 'Tahun Ajaran' } },
    { path: '/admin/grades', component: () => import('../views/AdminGrades.vue'), meta: { requiresAuth: true, role: 'admin', title: 'Rekap Nilai Siswa' } },
    { path: '/admin/attendances', component: () => import('../views/AdminAttendances.vue'), meta: { requiresAuth: true, role: 'admin', title: 'Presensi Siswa' } },
    { path: '/admin/attendance', component: () => import('../views/TeacherAttendance.vue'), meta: { requiresAuth: true, role: 'admin', title: 'Presensi Harian' } },
    { path: '/admin/profile', component: () => import('../views/AdminProfile.vue'), meta: { requiresAuth: true, role: 'admin', title: 'Profil Administrator' } },
    ...
    { path: '/admin/calendar-events', component: () => import('../views/AdminCalendar.vue'), meta: { requiresAuth: true, role: 'admin', title: 'Kalender Akademik' } },
