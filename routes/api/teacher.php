...
Route::middleware(['auth:sanctum', 'role:teacher,admin,operator,kurikulum,kepala_sekolah'])->prefix('teacher')->name('teacher.')->group(function () {
    ...
    Route::get('exam-corrections/options', [\App\Http\Controllers\Teacher\ExamCorrectionController::class, 'options']);
    ...
    Route::post('asts-reports/save-bulk-notes', [\App\Http\Controllers\AstsReportController::class, 'saveBulkNotes']);
